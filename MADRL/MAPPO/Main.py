...
if __name__ == '__main__':
    ...
    agent_para = {
        ...
        'batch_size': 128,  # Batch size (the number of episodes)
        'mini_batch_size': 64,  # Minibatch size (the number of episodes)
        'hidden_layer': [64, 64, 64],  # The number of neurons in hidden layers of the neural network
        'learning_rate': 5e-3,  # Learning rate of the actor and critic
